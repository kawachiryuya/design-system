...
<Meta title="Principles/Interaction/Gestures/Tap" />
...
**タップ領域の確保**:
→ [Touch Targets](../../Foundation/accessibility/touch-targets.mdx) 参照（最小44px × 44px）
...
- [Long Press](./long-press.mdx)
- **[Touch Targets](../../Foundation/accessibility/touch-targets.mdx)**: サイズ要件
