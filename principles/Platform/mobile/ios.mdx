...
<Meta title="Principles/Platform/Mobile/Ios" />
...
→ [Touch Targets](../../Foundation/accessibility/touch-targets.mdx) 参照
...
- [Android](./android.mdx): Android固有の考慮
- [Native Patterns](./native-patterns.mdx): ネイティブUI慣習
- **[Touch Targets](../../Foundation/accessibility/touch-targets.mdx)**: タッチサイズ
- **[Gestures](../../Interaction/gestures/overview.mdx)**: ジェスチャー操作
- **[Responsiveness](../../Foundation/responsiveness.mdx)**: レスポンシブ対応
