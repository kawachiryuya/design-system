...
<Meta title="Principles/Platform/Mobile/Native Patterns" />
...
→ [Navigation](../../Patterns/navigation.mdx) 参照
...
→ [Gestures: Swipe](../../Interaction/gestures/swipe.mdx) 参照
...
→ [Button: Placement](../../Interaction/button/placement.mdx) 参照
...
→ [Toast Notifications](../../Interaction/feedback/toast-notifications.mdx) 参照
...
→ [Gestures: Long Press](../../Interaction/gestures/long-press.mdx) 参照
...
- [iOS](./ios.mdx): iOS固有の実装
- [Android](./android.mdx): Android固有の実装
- **[Navigation](../../Patterns/navigation.mdx)**: ナビゲーションパターン
- **[Button: Placement](../../Interaction/button/placement.mdx)**: ボタン配置
- **[Gestures](../../Interaction/gestures/overview.mdx)**: ジェスチャー
- **[Toast Notifications](../../Interaction/feedback/toast-notifications.mdx)**: 通知
