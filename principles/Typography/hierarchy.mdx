...
- **[Typography Scale](./scale.mdx)**: フォントサイズ、ウェイト、行間、文字間隔の定義（基盤）
...
このセクションでは、[Typography Scale](./scale.mdx) で定義されたスケールを使って、各階層を定義します。
...
→ 詳細は [Typography Scale](./scale.mdx) 参照
...
→ 詳細は [Semantic Colors](../Color/semantic-colors.mdx)、[Color Contrast](../Foundation/accessibility/color-contrast.mdx) 参照
...
→ 詳細は [Accessibility Overview](../Foundation/accessibility/overview.mdx) 参照
...
- **[Accessibility](../Foundation/accessibility/overview.mdx)**: コントラスト比、ズーム対応
- **[Semantic Colors](../Color/semantic-colors.mdx)**: テキストカラーの意味付け
