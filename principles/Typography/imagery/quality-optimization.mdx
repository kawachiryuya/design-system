...
<Meta title="Principles/Typography/Imagery/Quality Optimization" />
...
- [Aspect Ratios](./aspect-ratios.mdx)
- **[Responsiveness](../../Foundation/responsiveness.mdx)**: srcsetとブレークポイント
